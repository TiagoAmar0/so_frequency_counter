...
const char *gengetopt_args_info_purpose = "Este programa tem como objetivo…";

const char *gengetopt_args_info_usage = "Usage: freqCounter [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -f, --file=filename  A string option, for a filename",
  "  -d, --dir=dirname    A string option, for a directory",
  "      --time           Shows time of execution",
  "  -m, --mode=INT       Mode of operation  (possible values=\"1\", \"2\", \"4\"\n                         default=`1')",
    0
};
...
const char *cmdline_parser_mode_values[] = {"1", "2", "4", 0}; /*< Possible values for mode. */
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->time_help = gengetopt_args_info_help[4] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVf:d:m:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'f':	/* A string option, for a filename.  */
          ...
          break;
        case 'd':	/* A string option, for a directory.  */
        ...
        case 'm':	/* Mode of operation.  */
          ...
          if (update_arg( (void *)&(args_info->mode_arg), 
              ...
              &(local_args_info.mode_given), optarg, cmdline_parser_mode_values, "1", ARG_INT,
              check_ambiguity, override, 0, 0,
              "mode", 'm',
              additional_error))
            goto failure;
